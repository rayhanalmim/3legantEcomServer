...
const comprehend = new aws_sdk_1.default.Comprehend();
...
function extractCustomEntities(text) {
...
function detectEntities(text) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield comprehend.detectEntities(params).promise();
...
function processText(text) {
    return __awaiter(this, void 0, void 0, function* () {
        const awsEntities = yield detectEntities(text); // AWS Comprehend entities
...
const extractData = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield processText(text);
